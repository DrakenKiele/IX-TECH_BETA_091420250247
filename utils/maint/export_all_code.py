# BREADCRUMB: [Project/Module] > export_all_code.py
...
# This script will recursively collect all .py file contents in the project and export them to a single file.
# It will include all code, comments, and docstrings.

OUTPUT_FILE = "all_code_export.txt"
EXTENSIONS = [".py"]
...
def export_all_code(root_dir, output_file):
    ...
    with open(output_file, "w", encoding="utf-8") as out:
        for fpath in code_files:
            ...
            with open(fpath, "r", encoding="utf-8", errors="ignore") as f:
                out.write(f.read())
                out.write("\n\n")
    print(f"Exported {len(code_files)} files to {output_file}")


if __name__ == "__main__":
    # Change this to your project root if running from a subfolder
    export_all_code(os.path.abspath(os.path.dirname(__file__)), OUTPUT_FILE)
