# BREADCRUMB: [Project/Module] > unblanker.py
...
"""
unblanker.py
Removes extra blank lines (no more than one in a row) and trailing spaces from the specified Python file.
Usage: python unblanker.py <filename.py>
"""
import sys
import os
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("Usage: python unblanker.py <filename.py>")
        sys.exit(1)
