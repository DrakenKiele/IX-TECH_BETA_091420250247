...
class AniotaTokenInterface {
    ...
    logEntry('constructor', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('createTokenInterface', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    generateTokenHTML() {
    logEntry('generateTokenHTML', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('giveToken', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('updateTrustLevel', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('updatePhase', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
                    currentPhase = phase;
    ...
    logEntry('updateObservation', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('updateStatus', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
                ...
                ipcRenderer.on('learning-update', (event, data) => {
                    ...
                    if (data.observation) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('observeBehavior', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {}) {
    ...
    logEntry('processToken', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
            // User can't afford token - show message and 
    logExit('currentFunction', if (this.tokenWindow) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js'));
    return if (this.tokenWindow) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
} catch (error) {
    log('Error in function: ' + error.message, 'ERROR');
    throw error;
    ...
    logExit('currentFunction', spendResult);
    return spendResult;
} catch (error) {
    log('Error in function: ' + error.message, 'ERROR');
    throw error;
    ...
    logExit('currentFunction', learningResult);
    ...
    logEntry('setupAutoObservation', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('generateTrainingReport', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('analyzeTrustProgression', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
    ...
    logEntry('calculateGrowthRate', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        if (values.length < 2) 
    ...
    logExit('currentFunction', totalGrowth / values.length);
    ...
    logEntry('calculateStability', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        if (values.length < 2) 
    logExit('currentFunction', 0);
    return 0;
    ...
    logExit('currentFunction', 1 / (1 + variance));
    return 1 / (1 + variance);
} catch (error) {
    log('Error in function: ' + error.message, 'ERROR');
    throw error;
    ...
    logEntry('calculateVariance', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        const mean = values.reduce((sum, val) => sum + val, 0) / values.length;
        const squaredDiffs = values.map(val => Math.pow(val - mean, 2));
        
    logExit('currentFunction', squaredDiffs.reduce((sum, diff) => sum + diff, 0) / values.length);
    ...
    logEntry('countExtinctionEvents', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        // Count how many behaviors were learned then extinguished
        // This proves the learning was real (behaviors can be unlearned)
        
    logExit('currentFunction', learningData.interactionHistory.filter(
    ...
    enableInterface() {
    logEntry('enableInterface', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        this.isActive = true;
        if (this.tokenWindow) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    ...
    disableInterface() {
    logEntry('disableInterface', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        this.isActive = false;
        if (this.tokenWindow) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    ...
    close() {
    logEntry('close', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
        if (this.tokenWindow) {
    logEntry('if', 'aniota_ui/biome/modules/aniotaBiome_tokenInterface.js');
    try {
